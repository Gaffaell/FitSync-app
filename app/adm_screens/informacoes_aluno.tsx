  ...
  return (
    <ScrollView>
      <ThemedView style={styles.container}>
        <ThemedText type="title" style={styles.titleContainer}>Informações de aluno</ThemedText>
        <Controller
          control={control}
          name="nome_aluno"
        ...
        />
        <Link href="/adm_screens/editar_informacoes_aluno" asChild>
          <Pressable
            style={styles.button}
          >
            <ThemedText>Editar informações</ThemedText>
          </Pressable>
        </Link>
        ...
        <Link href="/adm_home" asChild>
          <Pressable
            onPress={() => alert("Aluno excluído com sucesso")}
